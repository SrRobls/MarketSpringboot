...
public class LoteService {
    ...
    public LoteDTO createLote(LoteDTO loteDto, MultipartFile image, Long usuarioId) {
        ...
        // quitar cuando se arregle aws
        //if (image != null && !image.isEmpty()) {
            // En vez de subir la imagen a S3, usa un valor temporal
            //loteDto.setImage("https://via.placeholder.com/150");
        //}
    ...
    public Optional<LoteDTO> updateLote(Long id, String title, String description, Double price, String location, MultipartFile image) {
